...
import com.marcyliao.game.tapthetile.core.controller.GameController;
...
import com.marcyliao.game.tapthetile.utility.SizeHelper;
...
public class GameActivity extends BaseGameActivity {
    ...
    private int convertTileColorToAndroidColor(com.marcyliao.game.tapthetile.com.model.component.Color color) {
    ...
    private void initButtonListeners() {
        ...
        buttonShare.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                SoundManager.playSound(R.raw.click);
                ShareUtility.shareResult(GameActivity.this, gameController.getLevel());
            }
        });
